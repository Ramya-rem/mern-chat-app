...
const Home = () => {
  ...
  return (
  <div className='flex flex-col sm:flex-row sm:h-[450px] md:h-[550px] rounded-lg overflow-hidden bg-gray-400 bg-clip-padding sm:bg-clip-border backdrop-filter backdrop-blur-lg bg-opacity-0 lg:mt-20 sm:mt-0' >
